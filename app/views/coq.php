...
<html lang="en">
    ...
    <head>
        ...
        <title>Clash of Queens 2017 | Registeration</title>
...
#progstat{
 ...
 /* #AboutMACE{ */
    ...
    <div id="overlay">
                ...
                <div class="container">
                    <div class="row">
                        <div class="col-sm-8 col-sm-offset-2 text">
                        	<a href="index.html"><img style="height:100px;" src="http://takshak.in/2017/public/images/clashofqueens.png"></a>
                            <h1><strong>Clash of Queens 2017</strong> Registration</h1>
                            ...
                            <div class="top-big-link">
                                ...
                                <a class="btn launch-modal trigg2" href="#" data-modal-id="aboutClashofqueens"><img src="http://takshak.in/2017/public/images/aboutclashofclanstrig.png"/></a>
        	...
        	<div class="modal-dialog">
        		<div class="modal-content">
        			...
        			<div class="modal-body">
	                    ...
	                    <form role="form" action="http://takshak.in/2017/public/clashofqueens/submit" method="post" class="registration-form" enctype="multipart/form-data">
                            ...
                            <div class="form-member">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="email" name="form-member-2-email" placeholder="E-Mail" class="form-member-name form-control" id="form-member-2-email" value="<?=$member2name?>">
                                </div>
                                <div class="form-group">
                                    <label class="sr-only" for="form-member-2-phone">Phone</label>
                                    <input type="number" name="form-member-2-phone" placeholder="Phone" class="form-member-number form-control" id="form-member-2-number" value="<?=$member1name?>">
                                </div>
                            </div>
                            ...
                            <div class="form-member">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" name="form-member-3-name" placeholder="Name" class="form-member-name form-control" id="form-member-3-name" value="<?=$member3name?>">
                                </div>
                                <div class="form-group">
                                    <label class="sr-only" for="form-member-3-email">E-Mail</label>
                                    <input type="email" name="form-member-3-email" placeholder="E-Mail" class="form-member-name form-control" id="form-member-3-email" value="<?=$member2name?>">
                                </div>
                                <div class="form-group">
                                    <label class="sr-only" for="form-member-3-phone">Phone</label>
                                    <input type="number" name="form-member-3-phone" placeholder="Phone" class="form-member-number form-control" id="form-member-3-number" value="<?=$member1name?>">
                                </div>
                            </div>
                            ...
                            <div class="form-member">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" name="form-member-4-name" placeholder="Name" class="form-member-name form-control" id="form-member-4-name" value="<?=$member4name?>" >
                                </div>
                                <div class="form-group">
                                    <label class="sr-only" for="form-member-4-email">E-Mail</label>
                                    <input type="eamail" name="form-member-4-email" placeholder="E-Mail" class="form-member-name form-control" id="form-member-4-email" value="<?=$member2name?>">
                                </div>
                                <div class="form-group">
                                    <label class="sr-only" for="form-member-4-phone">Phone</label>
                                    <input type="number" name="form-member-4-phone" placeholder="Phone" class="form-member-number form-control" id="form-member-4-number" value="<?=$member1name?>">
                                </div>
                            </div>
                            ...
                            <div class="form-member">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" name="form-member-5-name" placeholder="Name" class="form-member-name form-control" id="form-member-5-name" value="<?=$member4name?>" >
                                </div>
                                <div class="form-group">
                                    <label class="sr-only" for="form-member-5-email">E-Mail</label>
                                    <input type="eamail" name="form-member-5-email" placeholder="E-Mail" class="form-member-name form-control" id="form-member-5-email" value="<?=$member2name?>">
                                </div>
                                <div class="form-group">
                                    <label class="sr-only" for="form-member-5-phone">Phone</label>
                                    <input type="number" name="form-member-5-phone" placeholder="Phone" class="form-member-number form-control" id="form-member-5-number" value="<?=$member1name?>">
                                </div>
                            </div>
        ...
        <div class="modal fade" id="aboutClashofqueens" tabindex="-1" role="dialog" aria-labelledby="modal-register-label" aria-hidden="true">
            <img id="AboutMACE" src="http://takshak.in/2017/public/images/aboutClashofqueens.png" data-dismiss="modal">
        </div>
