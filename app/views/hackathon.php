...
<html lang="en">
    ...
    <head>
        ...
        <title>Hackathon 2017 | Registeration</title>
...
#progstat{
 ...
 /* #AboutMACE{ */
    ...
    <div id="overlay">
                ...
                <div class="container">
                    <div class="row">
                        <div class="col-sm-8 col-sm-offset-2 text">
                        	<a href="index.html"><img style="height:100px;" src="http://takshak.in/2017/public/images/hackathon.png"></a>
                            <h1><strong>Hackathon 2017</strong> Registration</h1>
                            <div class="description">
                            	<p>
                                    ...
                                    Even if you dont win the price, you stand the chance of being placed.<br>
                            	</p>
                            </div>
                            <div class="top-big-link">
                                ...
                                <a class="btn launch-modal trigg2" href="#" data-modal-id="aboutHackathon"><img src="http://takshak.in/2017/public/images/abouthackathontrig.png"/></a>
        	...
        	<div class="modal-dialog">
        		<div class="modal-content">
        			...
        			<div class="modal-body">
	                    ...
	                    <form role="form" action="http://takshak.in/2017/public/hackathon/submit" method="post" class="registration-form" enctype="multipart/form-data">
                            ...
                            <div class="form-member">
                                ...
                                <div class="form-group">
                                    <label class="sr-only" for="form-member-1-semester">Semester</label>
                                    <input type="text" name="form-member-1-semester" placeholder="Semester*" class="form-member-school form-control" id="form-member-1-semester" value="<?=$member1school?>">
                                </div>
                            </div>
                            ...
                            <div class="form-member hidden-form-member">
                                ...
                                <div class="form-group">
                                    <label class="sr-only" for="form-member-2-semester">Semester</label>
                                    <input type="text" name="form-member-2-semester" placeholder="Semester*" class="form-member-school form-control form-optional" id="form-member-2-semester" value="<?=$member1school?>">
                                </div>
                            </div>
                            ...
                            <div class="form-member hidden-form-member">
                                ...
                                <div class="form-group">
                                    <label class="sr-only" for="form-member-3-semester">Semester</label>
                                    <input type="text" name="form-member-3-semester" placeholder="Semester*" class="form-member-school form-control form-optional" id="form-member-3-semester" value="<?=$member1school?>">
                                </div>
                            </div>
                            ...
                            <div class="form-member hidden-form-member">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" name="form-member-4-name" placeholder="Name" class="form-member-name form-control form-optional" id="form-member-4-name" value="<?=$member2name?>">
                                </div>
                                <div class="form-group">
                                ...
                                <div class="form-group">
                                    <label class="sr-only" for="form-member-4-contact">Contact</label>
                                    <input type="number" name="form-member-4-contact" placeholder="Contact Number" class="form-member-school form-optional form-control" id="form-member-4-contact" value="<?=$member1school?>">
                                </div>
                                <div class="form-group">
                                    <label class="sr-only" for="form-member-4-school">School</label>
                                    <input type="text" name="form-member-4-school" placeholder="Name Of College / School " class="form-member-school form-control form-optional" id="form-member-4-school" value="<?=$member2school?>">
                                </div>
                                <div class="form-group">
                                    <label class="sr-only" for="form-member-4-semester">Semester</label>
                                    <input type="text" name="form-member-4-semester" placeholder="Semester*" class="form-member-school form-control form-optional" id="form-member-4-semester" value="<?=$member1school?>">
                                </div>
                            </div>
                            ...
                            <div class="form-member hidden-form-member">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" name="form-member-5-name" placeholder="Name" class="form-member-name form-control form-optional" id="form-member-5-name" value="<?=$member2name?>">
                                </div>
                                <div class="form-group">
                                ...
                                <div class="form-group">
                                    <label class="sr-only" for="form-member-5-contact">Contact</label>
                                    <input type="number" name="form-member-5-contact" placeholder="Contact Number" class="form-member-school form-optional form-control" id="form-member-5-contact" value="<?=$member1school?>">
                                </div>
                                <div class="form-group">
                                    <label class="sr-only" for="form-member-5-school">School</label>
                                    <input type="text" name="form-member-5-school" placeholder="Name Of College / School " class="form-member-school form-control form-optional" id="form-member-5-school" value="<?=$member2school?>">
                                </div>
                                <div class="form-group">
                                    <label class="sr-only" for="form-member-5-semester">Semester</label>
                                    <input type="text" name="form-member-5-semester" placeholder="Semester*" class="form-member-school form-control form-optional" id="form-member-5-semester" value="<?=$member1school?>">
                                </div>
                            </div>
                            ...
                            <div class="form-member hidden-form-member">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" name="form-member-6-name" placeholder="Name" class="form-member-name form-control form-optional" id="form-member-6-name" value="<?=$member2name?>">
                                </div>
                                <div class="form-group">
                                    <label class="sr-only" for="form-member-6-email">E-Mail</label>
                                ...
                                <div class="form-group">
                                    <label class="sr-only" for="form-member-6-contact">Contact</label>
                                    <input type="number" name="form-member-6-contact" placeholder="Contact Number" class="form-member-school form-optional form-control" id="form-member-6-contact" value="<?=$member1school?>">
                                </div>
                                <div class="form-group">
                                    <label class="sr-only" for="form-member-6-school">School</label>
                                    <input type="text" name="form-member-6-school" placeholder="Name Of College / School " class="form-member-school form-control form-optional" id="form-member-6-school" value="<?=$member2school?>">
                                </div>
                                <div class="form-group">
                                    <label class="sr-only" for="form-member-6-semester">Semester</label>
                                    <input type="text" name="form-member-6-semester" placeholder="Semester*" class="form-member-school form-control form-optional" id="form-member-6-semester" value="<?=$member1school?>">
                                </div>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <input type="file" name="form-model" accept=".ppt, .pptx, .txt, .pdf, .doc, .docx, .dot, .dotx, .docm, .dotm, .pps, .pot, .ppa, .potx, .ppsx, .ppam, .pptm, .potm, .ppsm" class="form-optional" id="formmodelfile">
                            </div>
        ...
        <div class="modal fade" id="aboutHackathon" tabindex="-1" role="dialog" aria-labelledby="modal-register-label" aria-hidden="true">
        	<img id="AboutMACE" src="http://takshak.in/2017/public/images/aboutHackathon.png" data-dismiss="modal">
        </div>
