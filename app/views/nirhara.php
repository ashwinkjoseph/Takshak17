...
<html lang="en">
    ...
    <head>
        ...
        <title>Nirhara 2017 | Registeration</title>
...
#progstat{
 ...
 /* #AboutMACE{ */
    ...
    <div id="overlay">
                ...
                <div class="container">
                    <div class="row">
                        <div class="col-sm-8 col-sm-offset-2 text">
                        	<a href="index.html"><img style="height:100px;" src="http://takshak.in/2017/public/images/nirhara.png"></a>
                            <h1><strong>Nirhara 2017</strong> Registration</h1>
                            ...
                            <div class="top-big-link">
                                ...
                                <a class="btn launch-modal trigg2" href="#" data-modal-id="aboutNirhara"><img src="http://takshak.in/2017/public/images/aboutnirharatrig.png"/></a>
        	...
        	<div class="modal-dialog">
        		<div class="modal-content">
        			...
        			<div class="modal-body">
	                    ...
	                    <form role="form" action="http://takshak.in/2017/public/nirhara/submit" method="post" class="registration-form" enctype="multipart/form-data">
                            ...
                            <div class="form-member">
                                ...
                                <div class="col-sm-8" style="padding-left:0;">
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="form-member-2-school" placeholder="Name Of College / School " class="form-member-school form-control" id="form-member-2-school" value="<?=$member2school?>">
                                    </div>
                                </div>
                                <div class="col-sm-4"  style="padding-right:0;padding-left:0;">
                                    <div class="form-group">
                                        <label class="sr-only" for="form-member-2-age">Age</label>
                                        <input type="text" name="form-member-2-age" placeholder="Age" class="form-member-age form-control" id="form-member-2-age" value="<?=$member2age?>">
                                    </div>
                                </div>
                            </div>
        ...
        <div class="modal fade" id="aboutNirhara" tabindex="-1" role="dialog" aria-labelledby="modal-register-label" aria-hidden="true">
            <img id="AboutMACE" src="http://takshak.in/2017/public/images/aboutNirhara.png" data-dismiss="modal">
        </div>
