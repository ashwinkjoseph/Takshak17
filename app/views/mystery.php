...
<html lang="en">
    ...
    <head>
        ...
        <title>Mystery 2017 | Registeration</title>
...
#progstat{
 ...
 /* #AboutMACE{ */
    ...
    <div id="overlay">
                ...
                <div class="container">
                    <div class="row">
                        <div class="col-sm-8 col-sm-offset-2 text">
                        	<a href="index.html"><img style="height:100px;" src="http://takshak.in/2017/public/images/mystery.png"></a>
                            <h1><strong>Mystery 2017</strong> Registration</h1>
                            ...
                            <div class="top-big-link">
                                ...
                                <a class="btn launch-modal trigg2" href="#" data-modal-id="aboutMystery"><img src="http://takshak.in/2017/public/images/aboutmysterytrig.png"/></a>
        	...
        	<div class="modal-dialog">
        		<div class="modal-content">
        			...
        			<div class="modal-body">
	                    ...
	                    <form role="form" action="http://takshak.in/2017/public/mystery/submit" method="post" class="registration-form" enctype="multipart/form-data">
                            ...
                            <div class="form-member">
                                <h5>Member 1<span style="color:red">*</span></h5>
                            ...
                            <div class="form-member">
                                <h5>Member 2<span style="color:red">*</span></h5>
        ...
        <div class="modal fade" id="aboutMystery" tabindex="-1" role="dialog" aria-labelledby="modal-register-label" aria-hidden="true">
            <img id="AboutMACE" src="http://takshak.in/2017/public/images/aboutmystery.png" data-dismiss="modal">
        </div>
