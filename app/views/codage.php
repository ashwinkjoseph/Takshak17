...
<html lang="en">
    ...
    <head>
        ...
        <title>Codage 2017 | Registeration</title>
...
#progstat{
 ...
 /* #AboutMACE{ */
    ...
    <div id="overlay">
                ...
                <div class="container">
                    <div class="row">
                        <div class="col-sm-8 col-sm-offset-2 text">
                        	<a href="#"><img style="height:100px;" src="http://takshak.in/2017/public/images/codage.png"></a>
                            <h1><strong>Codage'17</strong> Registration</h1>
                            <div class="description">
                            	<p>
	                            	<b>Codage'17,</b>, The Ultimate Coding Arena consisting of 3 levels where each second has its value
                            	</p>
                            </div>
                            <div class="top-big-link">
                                ...
                                <a class="btn launch-modal trigg2" data-modal-id="aboutCodage" href="#"><img src="http://takshak.in/2017/public/images/aboutcodagetrig.png"/></a>
        	...
        	<div class="modal-dialog">
        		<div class="modal-content">
        			...
        			<div class="modal-body">
	                    ...
	                    <form role="form" action="http://takshak.in/2017/public/codage/submit" method="post" class="registration-form" enctype="multipart/form-data">
                            <hr/>
                            ...
                            <div class="form-member">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="number" name="form-member-1-contact" placeholder="Contact Number*" class="form-member-school form-control" id="form-member-2-contact" value="<?=$member1school?>">
                                </div>
                                <div class="form-group">
                                    <label class="sr-only" for="form-member-1-email">E-Mail</label>
                                    <input type="email" name="form-member-1-email" placeholder="E-Mail*" class="form-project-email form-control" id="form-email">
                                </div>
                            </div>
                            ...
                            <div class="form-member">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="number" name="form-member-2-contact" placeholder="Contact Number*" class="form-member-school form-control" id="form-member-2-contact" value="<?=$member1school?>">
                                </div>
                                <div class="form-group">
                                    <label class="sr-only" for="form-member-2-email">E-Mail</label>
                                    <input type="email" name="form-member-2-email" placeholder="E-Mail*" class="form-project-email form-control" id="form-member-2-email">
                                </div>
                            </div>
                            <hr/>
                            <div class="form-group">
                                <label class="sr-only" for="form-as-team-or-not">Do you need laptop*</label>
                                <span>Do you have a laptop?..</span><br>
                                <label><input type="radio" name="form-laptop" value="yes">We have our own laptops</label><br>
                                <label><input type="radio" name="form-laptop" value="partial">Only one member needs a laptop</label><br>
                                <label><input type="radio" name="form-laptop" value="no">Both members needs laptops</label>
                            </div>
                            <hr/>
                            <span style="color:red">Payment details will be given later, fee is 200 Rupees per Team Member</span>
        ...
        <div class="modal fade" id="aboutCodage" tabindex="-1" role="dialog" aria-labelledby="modal-register-label" aria-hidden="true">
            <img id="AboutMACE" src="http://takshak.in/2017/public/images/aboutCodage.png" data-dismiss="modal">
        </div>
