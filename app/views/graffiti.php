...
<html lang="en">
    ...
    <head>
        ...
        <title>Graffiti 2017 | Registeration</title>
...
#progstat{
 ...
 /* #AboutMACE{ */
    ...
    <div id="overlay">
                ...
                <div class="container">
                    <div class="row">
                        <div class="col-sm-8 col-sm-offset-2 text">
                        	<a href="#"><img style="height:100px;" src="http://takshak.in/2017/public/images/graffiti.png"></a>
                            <h1><strong>Graffiti 2017</strong> Registration</h1>
                            ...
                            <div class="top-big-link">
                                ...
                                <a class="btn launch-modal trigg2" data-modal-id="aboutGraffiti" href="#"><img src="http://takshak.in/2017/public/images/aboutgraffititrig.png"/></a>
        	...
        	<div class="modal-dialog">
        		<div class="modal-content">
        			...
        			<div class="modal-body">
	                    ...
	                    <form role="form" action="http://takshak.in/2017/public/graffiti/submit" method="post" class="registration-form" enctype="multipart/form-data">
        ...
        <div class="modal fade" id="aboutGraffiti" tabindex="-1" role="dialog" aria-labelledby="modal-register-label" aria-hidden="true">
            <img id="AboutMACE" src="http://takshak.in/2017/public/images/aboutgraffiti.png" data-dismiss="modal">
        </div>
