        ...
        <div class="container">
            <div class="row">
                <div class="col-sm-8 col-sm-offset-2 text">
                    ...
                    <a href="#"><img style="height:150px;" src="http://takshak.in/2017/public/images/droneprix.png"></a>
                    <h1><strong>MACE Drone Prix 2017</strong> Registration</h1>
                    ...
                    <div class="top-big-link">
                        ...
                        <a class="btn launch-modal trigg2" data-modal-id="aboutDronePrix" href="#"><img src="http://takshak.in/2017/public/images/aboutdroneprixtrig.png"/></a>
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <form role="form" action="http://takshak.in/2017/public/macedroneprix/submit" method="post" class="registration-form" enctype="multipart/form-data">
...
<div class="modal fade" id="aboutDronePrix" tabindex="-1" role="dialog" aria-labelledby="modal-register-label" aria-hidden="true">
    <!--    <img id="AboutMACE" src="http://takshak.in/2017/public/images/aboutHarley.png" data-dismiss="modal">-->
    <img id="AboutMACE" src="http://takshak.in/2017/public/images/aboutDronePrix.png" data-dismiss="modal">
</div>
