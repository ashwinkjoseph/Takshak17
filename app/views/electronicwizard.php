...
<html lang="en">
    ...
    <head>
        ...
        <title>Electronic Wizard 2017 | Registeration</title>
...
#progstat{
 ...
 /* #AboutMACE{ */
    ...
    <div id="overlay">
                ...
                <div class="container">
                    <div class="row">
                        <div class="col-sm-8 col-sm-offset-2 text">
                        	<a href="#"><img style="height:100px;" src="http://takshak.in/2017/public/images/ECWIZ.png"></a>
                            <h1><strong>Electronic Wizard 2017</strong> Registration</h1>
                            <!-- <div class="description">
                            	<p>
	                            	<b>Electronic Wizard 2017,</b> 
                            	</p>
                            </div> -->
                            <div class="top-big-link">
                                ...
                                <a class="btn launch-modal trigg2" data-modal-id="aboutECWIZ" href="#"><img src="http://takshak.in/2017/public/images/aboutECWIZ.png"/></a>
        	...
        	<div class="modal-dialog">
        		<div class="modal-content">
        			...
        			<div class="modal-body">
	                    ...
	                    <form role="form" action="http://takshak.in/2017/public/electronicwizard/submit" method="post" class="registration-form" enctype="multipart/form-data">
                            <hr/>
                            ...
                            <hr/>
                            <hr/>
                            <span style="color:red">Payment details will be given later, fee is 100 Rupees per Team Member</span>
        ...
        <div class="modal fade" id="aboutECWIZ" tabindex="-1" role="dialog" aria-labelledby="modal-register-label" aria-hidden="true">
            <img id="AboutMACE" src="http://takshak.in/2017/public/images/ELECTRONICWIZARD.png" data-dismiss="modal">
        </div>
