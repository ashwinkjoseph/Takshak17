...
<head>
    ...
    <title>Jugaad IT 2017 | Registeration</title>
        ...
        <div class="container">
            <div class="row">
                <div class="col-sm-8 col-sm-offset-2 text">
                    <a href="#"><img style="height:150px;" src="http://takshak.in/2017/public/images/Jugaad.png"></a>
                    <h1><strong>Jugaad IT 2017</strong> Registration</h1>
                    <div class="description">
                        <p>
                            <b>Jugaad IT</b> Put the techie in you to test as you decipher the toughest of codes and circuitry before the clock ticks off!
                        </p>
                    </div>
                    <div class="top-big-link">
                        ...
                        <a class="btn launch-modal trigg2" data-modal-id="aboutJugaad" href="#"><img src="http://takshak.in/2017/public/images/aboutjugaadtrig.png"/></a>
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <form role="form" action="http://takshak.in/2017/public/prayaan/submit" method="post" class="registration-form" enctype="multipart/form-data">
                    ...
                    <hr/>
                    <span style="color:red">Payment details will be given later, fee is 100 Rupees</span>
...
<div class="modal fade" id="aboutJugaad" tabindex="-1" role="dialog" aria-labelledby="modal-register-label" aria-hidden="true">
    <img id="AboutMACE" src="http://takshak.in/2017/public/images/aboutJugaad.png" data-dismiss="modal">
</div>
