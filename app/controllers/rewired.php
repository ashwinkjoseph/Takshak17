...
class rewired extends controller{

    public function index(){
        $this->view("rewiredNew");
    }
    ...
    protected function prepareEmail( $formData ) {
        ...
        $from = "rewired@takshak.in";
        $subject ="New Registration for Rewired"; 
        $message = "Uploaded File\n";
        $message .= "Name :". $formData['form-college-name']."\n";
